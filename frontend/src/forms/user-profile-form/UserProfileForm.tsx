...
const formSchema = z.object({
  ...
  addressLine1: z.string().min(1, "addressLine1 is needed"),
  city: z.string().min(1, "city is needed"),
  country: z.string().min(1, "country is needed"),
});
    ...
    <Form {...form}>
      ...
      >
        <div>
          ...
          <FormDescription>View and change the profile here...</FormDescription>
        </div>
        <FormField
